...
public class StudentController {
    ...
    public String actionDelete(HttpServletRequest request, @Valid @ModelAttribute StudentRequest obj) {
        studentService.delete(obj.getId());
        return "redirect:/students";
